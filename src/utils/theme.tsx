    ...
    MuiFilledInput: {
      styleOverrides: {
        root: {
          ...
          borderRadius: 3,
          border: "1px solid",
          borderColor: theme.palette.form.main,
          ...
          "&.Mui-disabled": {
            // backgroundColor: theme.palette.form.disabled,
            // borderColor: theme.palette.form.disabled,
            color: "#6E6E6E",
          },
        },
        input: {
    ...
    MuiMenu: {
      styleOverrides: {
        paper: {
          ...
          boxShadow: `0 2px 4px 0 ${theme.palette.form.main} !important`,
        },
        list: {
